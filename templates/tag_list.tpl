...
<div class="tag-jumpto" style="padding-top: 10px;">
    <form id="form-tag-jumpto" name="form-tag-jumpto" action="<{$xoops_url}>/modules/<{$xoops_dirname}>/view.tag.php"
          method="get">
        <div>
            <label for="term" style="float: left; margin-right: 1em;"><{$lang_jumpto}>: </label><input type="text" id="term" name="term" value="" size="20"> <input type="submit" name="submit" value="<{$smarty.const._SUBMIT}>">
        </div>
    </form>
</div>
