...
<div id="pagenav" class="text-center py-2 my-3">
    <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/list.tag.php" title="<{$smarty.const._MD_TAG_TAGS}>" class="btn btn-secondary px-4" role="button" ><span class="fa fa-tags fa-lg fa-fw"></span> <{$smarty.const._MD_TAG_TAGS}>...</a>
<!--
   <{$pagenav}> 
-->
</div>