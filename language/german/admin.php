...
define('_AM_TAG_STATS', 'Statistik Infomation');
define('_AM_TAG_COUNT_TAG', 'Taganzahl: %s');
define('_AM_TAG_COUNT_ITEM', 'Stück: %s');
define('_AM_TAG_COUNT_MODULE', 'Modul:');
define('_AM_TAG_COUNT_MODULE_TITLE', 'Stück / Taganzahl');

define('_AM_TAG_EDIT', 'TagAdmin');
define('_AM_TAG_SYNCHRONIZATION', 'Synchroniziere');

define('_AM_TAG_ACTIVE', 'Aktiv');
define('_AM_TAG_INACTIVE', 'Inaktiv');
define('_AM_TAG_GLOBAL', 'Global');
define('_AM_TAG_ALL', 'Alle Module');
define('_AM_TAG_NUM', 'Anzahl je Durchlauf');
define('_AM_TAG_IN_PROCESS', 'Datensynchronisation läuft, bitte warten Sie eine Weile ...');
define('_AM_TAG_FINISHED', 'Die Datensynchronisation ist beendet.');
...
*/
//2.32
define('_AM_TAG_INDEX_TPL_DESC', 'Indexseite des Tag-Moduls');
define('_AM_TAG_INDEX_TPL_LIST_DESC', 'Liste der Tags');
