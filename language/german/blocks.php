...
define('_MB_TAG_ITEMS', 'angezeigte Tags');
...
define('_MB_TAG_SORT', 'Sortierung');
define('_MB_TAG_ALPHABET', 'Alphabetisch');
define('_MB_TAG_COUNT', 'Anzahl der Worte');
define('_MB_TAG_TIME', 'Zeit');
